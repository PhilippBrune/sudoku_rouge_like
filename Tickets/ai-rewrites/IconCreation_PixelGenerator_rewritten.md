...
This project includes an editor tool that generates placeholder icon sets, a packed atlas, and a CSV mapping file to bootstrap UI icon usage. The final visual targets come from the illustrated production sheet (`icon_production_sheet.png`), not a pixel-art final style.
