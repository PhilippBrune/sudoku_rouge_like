...
**Version:** 1.2 | **Date:** 2026-04-16 | **Status:** implemented

### Change History

| Version | Date | Status | Changes |
|---------|------|--------|---------|
| 1.2 | 2026-04-16 | implemented | Inline requirement IDs added (ECON-REWARD-001, ECON-SHOP-001/002, SHOP-PRICE-001). Stale auto-generated traceability table replaced. |
...
### Puzzle Completion Reward Formula `[ECON-REWARD-001]`
...
### Shop Purchases `[ECON-SHOP-001]` `[ECON-SHOP-002]` `[SHOP-PRICE-001]`
...
|--------|---------|-----------|--------|
| `ECON-REWARD-001` | Puzzle Completion Reward Formula | `Assets/Scripts/Economy/GoldTable.cs` · `CalculatePuzzleGold`; `Assets/Scripts/Run/RunDirector.cs` · `CompleteLevelAndGrantRewards` | ✅ |
| `ECON-SHOP-001` | Shop Purchases — inventory size | `Assets/Scripts/Economy/ShopService.cs` · `BuildOffers` | ✅ |
| `ECON-SHOP-002` | Shop Purchases — price scaling | `Assets/Scripts/Economy/ShopService.cs` · `BuildOffers` | ✅ |
| `SHOP-PRICE-001` | Item Economy / Price Scaling | `Assets/Scripts/Items/ItemService.cs` · `GetShopPrice`; `Assets/Scripts/Economy/GoldTable.cs` · `ShopItemPrice` | ✅ |
