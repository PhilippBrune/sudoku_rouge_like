...
|--------|-------|----------------|
| REQ-UI-018 | REQ_TITLE1 | LINKED_SYSTEMS: AccessibilitySettings |
| REQ-UI-019 | REQ_TITLE2 | LINKED_SYSTEMS: GameplaySettings, AccessibilitySettings |
| REQ-UI-020 | REQ_TITLE3 | LINKED_SYSTEMS: AccessibilitySettings |
| REQ-UI-021 | REQ_TITLE4 | LINKED_SYSTEMS: AccessibilitySettings |
| REQ-UI-022 | REQ_TITLE5 | LINKED_SYSTEMS: AccessibilitySettings, GameplaySettings |
| REQ-UI-023 | REQ_TITLE6 | LINKED_SYSTEMS: GameplaySettings |
| REQ-UI-024 | REQ_TITLE7 | LINKED_SYSTEMS: AccessibilitySettings, GameplaySettings |
| REQ-UI-025 | REQ_TITLE8 | LINKED_SYSTEMS: AccessibilitySettings, GridRenderer |
| REQ-UI-026 | REQ_TITLE9 | LINKED_SYSTEMS: AccessibilitySettings, GameplaySettings, CageController |
