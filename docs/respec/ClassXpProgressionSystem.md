...
### Phase 1 — Linear Growth (Levels 1 → 15)
...
### Phase 2 — Accelerated Growth (Levels 16 → 40)
...
### Modifier Bonus (per Boss Puzzle)
...
## End-of-Run XP Breakdown Screen
