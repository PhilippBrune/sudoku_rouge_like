...
|--------|-------|----------------|
| REQ-SHOP-016 | GoldEconomySystem | RunDirector |
| REQ-SHOP-017 | GoldAcquisitionSystem | RunDirector |
| REQ-SHOP-018 | AdditionalGoldSourcesSystem | RunDirector |
| REQ-SHOP-019 | GoldSpendingSystem | RunDirector |
| REQ-SHOP-020 | GoldEconomyPerFloorSystem | RunDirector |
| REQ-SHOP-021 | EconomyBalanceTargetsSystem | RunDirector |
| REQ-SHOP-022 | GoldPersistenceSystem | ProfileService |
| REQ-SHOP-023 | SellMechanicsSystem | RunDirector |
| REQ-SHOP-024 | NothingSlotBehaviourSystem | RunDirector |
