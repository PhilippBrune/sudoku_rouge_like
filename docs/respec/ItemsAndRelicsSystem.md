...
#### Relic Node Tile — Tier Weights by Floor
...
|--------|-------|-----------|-----------------|--------|
| REQ-RELIC-014 | TITLE | `—` | — | ✗ missing |
| REQ-RELIC-015 | ItemsAndRelicsSystem | `Assets\Scripts\Economy\RelicService.cs` | RelicService | ✓ verified |
| REQ-RELIC-016 | TITLE | `Assets\Scripts\UI\MainMenuController.cs` | — | ✓ verified |
| REQ-RELIC-017 | TITLE | `Assets\Scripts\Run\RunDirector.cs` | — | ✓ verified |
| REQ-RELIC-018 | TITLE | `Assets\Scripts\Run\RunDirector.cs` | — | ✓ verified |
| REQ-RELIC-019 | TITLE | `Assets\Scripts\Economy\RelicService.cs` | — | ✓ verified |
| REQ-RELIC-020 | TITLE | `Assets\Scripts\Items\ItemService.cs` | — | ✓ verified |
| REQ-RELIC-021 | TITLE | `Assets\Scripts\UI\MainMenuController.cs` | — | ✓ verified |
| REQ-RELIC-022 | TITLE | `Assets\Scripts\Economy\RelicService.cs` | RelicService | ✓ verified |
| REQ-RELIC-023 | TITLE | `Assets\Scripts\UI\MainMenuController.cs` | — | ✓ verified |
| REQ-RELIC-024 | TITLE | `Assets\Scripts\Run\RunDirector.cs` | — | ✓ verified |
| REQ-RELIC-025 | TITLE | `Assets\Scripts\Economy\ShopService.cs` | — | ✓ verified |
| REQ-RELIC-026 | TITLE | `Assets\Scripts\Run\RunDirector.cs` | — | ✓ verified |
| REQ-RELIC-027 | TITLE | `Assets\Scripts\UI\MainMenuController.cs` | — | ✓ verified |
| REQ-RELIC-028 | TITLE | `Assets\Scripts\UI\ProceduralSfxLibrary.cs` | — | ✓ verified |
